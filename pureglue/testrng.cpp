...
int main( void )
{
  ...
  /* Create streams */
  clrngMrg31k3pStreamCreator* streamcreator;
  clrngMrg31k3pStreamState state = {{1,1,5},{123,1345,145}};
  clrngMrg31k3pSetBaseCreatorState(streamcreator, &state);
  streams = clrngMrg31k3pCreateStreams(streamcreator, numWorkItems, &streamBufferSize, (clrngStatus *)&err);
